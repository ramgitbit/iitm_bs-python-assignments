...
output2 = word1[0:4] + "_" + word2[-4:]# str: join first four letters of word1 and last four letters of word 2 with a hyphen "-" in between

output3 = word3 + " " + str(n1)# str: join the word3 and n1 with a space in between

output4 = "-"*50 # str: just the hypen "-" repeated 50 times

output5 = "_" * n2# str: just the hypen "-" repeated n2 times
...
is_word1_comes_before_other_two = word1[0]<word2[0] and word1[0]< word3[0] #iitm sol( word1 < word2 and word1 < word3)# bool: True if word1 comes before word2 and word3 assume all words are different

has_h = "h" in word1# bool: True if word1 has the letter h

ends_with_a = word1.endswith("a") or word1[-1] == "A" # bool: True if word1 ends with letter a or A
