...
is_offer1_cheaper = (price1*(1-discount1/100)) < (price2*(1-discount2/100)) # bool: True if the offer1 is strictly 
# Discount(4% or 8%) ko decimal me convert karke (discount/100), usse 1 me se minus karte hain(1 ka matlab 100% hota hai) to remaining percentage milta hai
# Fir us remaining value ko price se multiply karke final discounted price nikalte hain
print(output1)
print(output2)
print(output3)
print(output4)
